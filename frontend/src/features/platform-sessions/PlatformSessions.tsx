 ...
 *
 * Named here because this file is the one place in the App that polls, and a
 * poller that does not know the limit will exceed it. Kept in step with
 * `limit_req_zone … rate=10r/s` in the deployed Nginx site.
 */
