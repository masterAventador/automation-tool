"""Alembic environment backed by the validated Control Plane database URL."""
...
async def run_async_migrations() -> None:
    """Create a short-lived async engine and run migrations on its sync facade."""
...
def run_migrations_online() -> None:
    """Run migrations through SQLAlchemy's asyncio extension."""
