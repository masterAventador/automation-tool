...
class FakeRepository:
    ...
    async def save_challenge(self, challenge: object) -> None:
        self.saved = challenge

    async def complete_challenge(self, **kwargs: object) -> object:
...
async def test_completion_reauthenticates_account_and_creates_fresh_credential() -> None:
    ...
    assert repository.completed["pending_credential"].credential.startswith("atdc1.")
