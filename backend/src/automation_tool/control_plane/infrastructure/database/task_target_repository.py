...
async def evaluate_and_replace_task_targets(
    ...
    *,
    ...
    """Shared transaction primitive used by the repository and discovery convergence."""
    ...
    existing_evaluated_times = {cast(datetime, row["evaluated_at"]) for row in existing_rows}
        ...
        *,
        ...
        try:
            async with self._database.session() as session:
                return await evaluate_and_replace_task_targets(
                    session,
                    task_id=target_task,
