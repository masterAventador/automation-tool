...
**LE-12 T1～T4 已完成；下一步进入 T5 macOS/Windows 原生生命周期验收与 LE 收口。** LE-10 已交付从真实领域投影、绝对
...
组件销毁重建和启动期两阶段 checkpoint 预检闭环。现在进入 T5，在 macOS/Windows 用同一非 ignored
目标启动真实本地剪辑 Worker 进程并完成生命周期收口。
