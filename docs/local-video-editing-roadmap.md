...
**LE-10 T1～T7、LE-11 T1～T2 已完成；LE-11 T3 进入本地音频事实绑定 RED。** LE-10 已交付从真实领域投影、绝对
...
音频图均为 48kHz stereo、1000ms；T3 开始把 LE-07 的 `has_audio` 事实和本地绝对路径绑定到
计划，并保证无声 ambient 与 muted 素材不进入 FFmpeg 输入。
