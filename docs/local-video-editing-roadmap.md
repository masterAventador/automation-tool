...
**LE-10 T1 已经四轮提交级 Review 收口并完成；T2 进入 RED。**
T1 最终以完整领域构造器重建 Project、所有 track/clip/transition 后才投影，第四轮复审
专项 41 条、145 条语句/32 分支 100%，受影响回归 259 条，无新增 finding。T2 现在用
绝对毫秒边界半向上量化到帧号，覆盖 0 帧 clip、0 帧转场和转场吞没 clip 三类固定拒绝；
