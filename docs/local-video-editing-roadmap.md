...
**LE-10 T1～T7、LE-11 T1～T4 已完成；LE-11 T5 进入三态真实电平验收与 LE 收口 RED。** LE-10 已交付从真实领域投影、绝对
...
ffprobe fail-closed 核验。T5 开始用同源三份真实成片的 PCM 频段电平证明自动闪避、固定音量
和静音确实可听地区分，再跑 LE 结束门禁。
