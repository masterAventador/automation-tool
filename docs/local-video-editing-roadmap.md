...
**LE-16 T1 语义匹配已完成。** 首轮 Codex Review 的两项边界问题均经 RED/GREEN 修复，
第二轮 Review 无 finding；最终专项 51 条、新模块语句/分支覆盖 100%，与既有脚本分句
相关回归共 107 条。下一步进入 T2，在执行器确认的实际可解码区间内选择等长片段，不以
容器声明时长推断帧完备。
