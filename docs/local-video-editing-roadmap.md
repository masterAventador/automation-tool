...
**LE-12 T1～T3 已完成；下一步进入 T4 有限崩溃恢复与 App 重启作业恢复。** LE-10 已交付从真实领域投影、绝对
...
超限/损坏 schema 均 fail closed，双平台专项全绿。现在进入 T4 的有限 Worker 崩溃恢复和 App
重启后持久作业 reconciliation。
