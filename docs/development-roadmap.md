...
| T18-cloud-deploy | 真实云主机 Demo 部署 | 在客户云主机 `at.xuanbai.tech` 上真实落地 Control Plane + PostgreSQL + 主机 nginx 边界；可重复部署脚本进仓库；从本机走公网 HTTPS 完成产品账号登录与认证业务接口验收 | C10-08..C10-13 | 🚧 实现中 |
