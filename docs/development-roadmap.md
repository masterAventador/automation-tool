...
| 设备身份密钥 | `🔍` Ed25519 首启生成、macOS Keychain 真实往返、React/普通文件零暴露和桌面隔离身份已通过；等待 Windows Credential Manager CI 验收 |
...
| I2-04 | 设备密钥生成 | Tauri 首启生成 Ed25519 密钥；私钥不进入 React/普通文件 | F1-07,I2-01 | 🔍 待验收 |
