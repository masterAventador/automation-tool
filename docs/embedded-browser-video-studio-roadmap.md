...
| BM-16 | 确定性与正式包验收 | 同输入/版本/字体/资源生成稳定结果；一句话、无模型手工模板边界、12 套整体风格和全部 134 项逐项预览/渲染；验证首期无 URL 输入/抓取入口，并覆盖断网/VPN 缺失、低配置、并发、崩溃、休眠、磁盘和双平台包。**2026-07-31 macOS 内容级收口：134/134 均保留非空代表帧与像素事实，133 项真实运动、唯一静态叠层按设计排除；25 个 component 使用 16 个多点文档宿主 + 9 个受控片段宿主，生成 11 张中文分类联系表并人工抽查；12 风格、30 帧双跑确定性及异步 3D 时间轴回归通过。Windows 正式包及其余平台/压力证据仍待补，不提前改完成态。** | BM-08,BM-11..BM-15,VF-04（不含后置 BM-09～BM-10） | 🔍 待验收 |
