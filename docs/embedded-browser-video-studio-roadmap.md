...
| EB-16 | 首发安装包与签名 | macOS arm64、macOS x86_64、Windows x86_64 每个目标只打包对应的一套完整 Chromium；macOS 内层签名/公证、Windows 签名、首次安装/卸载、包体积、进程退出和残留资源。**2026-07-31 对当前 macOS arm64 生产包复验：App 深度严格签名、App/DMG 装订和 Gatekeeper 均通过，Developer ID Team 为 HK56FS93AD；DMG `hdiutil verify` 有效，538,605,619 bytes，SHA-256 `b37da6df0c1972d9739474e9b7ec5ab3ee6148d1064aa87c3b993df2f64ba9a6`。历史 ad-hoc 缺口已关闭；macOS x86_64、Windows Authenticode/SmartScreen 与 Windows 交互式 App 启动仍待补。** | EB-15 | 🔍 待验收 |
