...
| ID | 任务 | 交付与验收 | 依赖 | 当前状态 |
| --- | --- | --- | --- | --- |
| CQ-01 | 普通用户可理解性验收 | 用户不看技术文档也能选对两种制作方式，分清 12 套整体风格、134 个动效零件和独立视频剪辑模块；界面无未解释行业词 | IM-08,BM-16,VE-08 | 🔍 待验收 |
