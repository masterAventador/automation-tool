...
| VF-04 | 统一 FFmpeg/ffprobe 供应链 | 锁版本、摘要、许可证、编解码器、macOS/Windows 打包；验证两种制作方式兼容后才共享一套二进制 | VF-02 | 🔍 待验收 |
...
| IM-02 | 隔离 Python Worker 与依赖打包 | 与 RPA Executor 分开冻结，验证 Python 3.11+、MoviePy、语音/字幕依赖、启动时间、包体和资源许可证 | IM-01,VF-02 | 🔍 待验收 |
| IM-03 | 安全启动器和本地网关 | 只监听随机 loopback；会话令牌、来源/路径白名单、请求大小、超时、素材文件 containment、CORS 和错误脱敏 | IM-02,VF-03 | 🔍 待验收 |
